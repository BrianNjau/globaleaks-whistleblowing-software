...
sudo apt-get -y install brotli curl git debhelper devscripts dh-apparmor dh-python pybuild-plugin-pyproject python3-all python3-pip python3-setuptools python3-sphinx
