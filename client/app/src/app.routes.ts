...
export const appRoutes: Routes = [
  {
    ...
    pathMatch: "full",
    loadComponent: () =>
      import("@app/shared/blank/blank.component").then((m) => m.BlankComponent),
  },
  {
    path: "",
  ...
  },
  {
    ...
    canActivate: [Pageguard],
    loadComponent: () =>
      import("@app/pages/whistleblower/submission/submission.component").then(
  ...
  },
  {
    path: "action",
    loadChildren: () =>
      import("./pages/action/action.routes").then((m) => m.actionRoutes),
  },
  {
    path: "recipient",
    canActivate: [ReceiverGuard],
    loadChildren: () =>
      import("./pages/recipient/recipient.routes").then(
        (m) => m.recipientRoutes
      ),
    data: {
  ...
  },
  {
    ...
    resolve: {
      PreferenceResolver,
      NodeResolver,
      RtipsResolver: RTipsResolver,
      IarsResolver: IarResolver,
    },
    loadChildren: () =>
      import("./pages/custodian/custodian.routes").then(
        (m) => m.custodianRoutes
      ),
    data: {
  ...
  },
  {
    ...
    loadChildren: () =>
      import("./pages/analyst/analyst.routes").then((m) => m.analystRoutes),
    data: {
  ...
  },
  {
    ...
    loadComponent: () =>
      import(
        "@app/pages/auth/password-reset-response/password-reset-response.component"
      ).then((m) => m.PasswordResetResponseComponent),
  },
  {
    path: "activation",
    data: { pageTitle: "Sign up" },
    loadComponent: () =>
      import(
        "@app/pages/signup/templates/activation/activation.component"
  ...
  },
  {
    ...
    loadChildren: () =>
      import("./pages/wizard/wizard.routes").then((m) => m.wizardRoutes),
  },
  {
    path: "reports/:tip_id",
    ...
    loadComponent: () =>
      import("@app/pages/recipient/tip/tip.component").then(
        (m) => m.TipComponent
      ),
